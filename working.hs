...
evalBoard (Board rowsNum board) symb = (evalBoardRowWise board symb) + (evalBoardRowWise (cwRotate board) symb) + (evalBoardRowWise (diagonals board) symb) + (evalBoardRowWise (diagonalsCw board) symb)
